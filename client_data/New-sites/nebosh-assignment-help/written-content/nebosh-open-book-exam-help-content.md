# NEBOSH Open Book Exam Help: How to Answer OBE Tasks and Achieve Distinction

The NEBOSH Open Book Exam is a scenario-based assessment in which candidates receive a written workplace scenario and a question paper simultaneously, then submit answers via NEBOSH's online platform within a fixed time window. The most critical skill the OBE tests is not health and safety knowledge in isolation — it is the ability to apply the correct answer structure for each command word in the question paper while referencing specific evidence from the scenario. Using the wrong answer structure for a command word is the single most common cause of low scores in the NEBOSH OBE, regardless of a candidate's actual level of H&S knowledge. Our NEBOSH-qualified consultants provide command word coaching, scenario analysis training, and pre-submission answer review for candidates preparing for or resitting the NG1 or IG1 Open Book Exam.
...
<svg viewBox="0 0 800 300" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:800px; display:block; margin:0 auto;" role="img" aria-labelledby="obe-format-title">
  <title id="obe-format-title">NEBOSH OBE Format — Four Key Facts Every Candidate Must Know</title>
  <desc>Process flow showing the four essential facts about the NEBOSH Open Book Exam format: 24-hour window, workplace scenario, open-book permitted materials, and submission via NEBOSH portal.</desc>
  ...
  <text x="400" y="34" text-anchor="middle" font-family="Georgia, serif" font-size="20" font-weight="bold" fill="white">NEBOSH OBE — Four Facts Every Candidate Must Know</text>
  ...
  <text x="100" y="147" text-anchor="middle" font-family="Georgia, serif" font-size="11" fill="#1B3A6B" opacity="0.7">FACT</text>
  ...
  <text x="100" y="205" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#1B3A6B">24-Hour Window</text>
  <text x="100" y="222" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Reduced from 48hrs</text>
  <text x="100" y="237" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Sept 2023 update</text>
  ...
  <text x="300" y="147" text-anchor="middle" font-family="Georgia, serif" font-size="11" fill="#1B3A6B" opacity="0.7">FACT</text>
  ...
  <text x="300" y="205" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#1B3A6B">Scenario-Based</text>
  <text x="300" y="222" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">2,000–3,000 word</text>
  <text x="300" y="237" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">workplace document</text>
  ...
  <text x="500" y="147" text-anchor="middle" font-family="Georgia, serif" font-size="11" fill="#1B3A6B" opacity="0.7">FACT</text>
  ...
  <text x="500" y="205" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#1B3A6B">Open-Book</text>
  <text x="500" y="222" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Notes, textbooks,</text>
  <text x="500" y="237" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">study guides allowed</text>
  ...
  <text x="700" y="147" text-anchor="middle" font-family="Georgia, serif" font-size="11" fill="white" opacity="0.7">FACT</text>
  ...
  <text x="700" y="205" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#1B3A6B">NEBOSH Portal</text>
  <text x="700" y="222" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Submit via candidate</text>
  <text x="700" y="237" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">portal — no extensions</text>

  <text x="400" y="285" text-anchor="middle" font-family="Arial, sans-serif" font-size="10" fill="#aaa">nebosh-assignment-help.co.uk</text>
</svg>
<figcaption style="font-size:0.85rem; color:#666; margin-top:0.5rem;">NEBOSH Open Book Exam format — four essential facts candidates must understand before the assessment window opens.</figcaption>
</figure>
...
<figure class="infographic-figure" style="text-align:center; margin: 2rem auto;">
<svg viewBox="0 0 800 560" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:800px; display:block; margin:0 auto;" role="img" aria-labelledby="cmd-words-obe-title">
  <title id="cmd-words-obe-title">NEBOSH OBE Command Words — Six Definitions With Example Questions and Answer Structures</title>
  <desc>Icon grid showing all six NEBOSH OBE command words with their required answer depth and format: Identify, Outline, Describe, Explain, Suggest, and Justify.</desc>
  ...
  <text x="400" y="40" text-anchor="middle" font-family="Georgia, serif" font-size="22" font-weight="bold" fill="white">NEBOSH OBE Command Words — Depth Guide</text>
  <rect y="64" width="800" height="3" fill="#C9A84C"/>

  <!-- ROW 1 — Identify and Outline -->
  <rect x="20" y="80" width="370" height="140" fill="white" rx="10" stroke="#C9A84C" stroke-width="1.5" stroke-opacity="0.3"/>
  <circle cx="70" cy="128" r="25" fill="#1B3A6B" opacity="0.12"/>
  <text x="70" y="135" text-anchor="middle" font-size="22">🔍</text>
  <text x="115" y="102" font-family="Georgia, serif" font-size="16" font-weight="bold" fill="#1B3A6B">Identify</text>
  <text x="115" y="122" font-family="Arial, sans-serif" font-size="12" fill="#444">List or state — no explanation needed</text>
  <text x="115" y="140" font-family="Arial, sans-serif" font-size="12" fill="#444">Brief, specific answers only</text>
  <text x="70" y="195" font-family="Arial, sans-serif" font-size="11" fill="#C9A84C" font-weight="bold">Example:</text>
  <text x="115" y="195" font-family="Arial, sans-serif" font-size="11" fill="#666">"Identify FOUR hazard types" → bullet list</text>

  <rect x="410" y="80" width="370" height="140" fill="white" rx="10" stroke="#C9A84C" stroke-width="1.5" stroke-opacity="0.3"/>
  <circle cx="460" cy="128" r="25" fill="#1B3A6B" opacity="0.12"/>
  <text x="460" y="135" text-anchor="middle" font-size="22">📋</text>
  <text x="505" y="102" font-family="Georgia, serif" font-size="16" font-weight="bold" fill="#1B3A6B">Outline</text>
  <text x="505" y="122" font-family="Arial, sans-serif" font-size="12" fill="#444">Key features — more than list, less than full</text>
  <text x="505" y="140" font-family="Arial, sans-serif" font-size="12" fill="#444">4–6 sentences or bullet points</text>
  <text x="460" y="195" font-family="Arial, sans-serif" font-size="11" fill="#C9A84C" font-weight="bold">Example:</text>
  <text x="505" y="195" font-family="Arial, sans-serif" font-size="11" fill="#666">"Outline permit-to-work" → main components</text>

  <!-- ROW 2 — Describe and Explain -->
  <rect x="20" y="235" width="370" height="140" fill="white" rx="10" stroke="#C9A84C" stroke-width="1.5" stroke-opacity="0.3"/>
  <circle cx="70" cy="283" r="25" fill="#1B3A6B" opacity="0.12"/>
  <text x="70" y="290" text-anchor="middle" font-size="22">✍️</text>
  <text x="115" y="257" font-family="Georgia, serif" font-size="16" font-weight="bold" fill="#1B3A6B">Describe</text>
  <text x="115" y="277" font-family="Arial, sans-serif" font-size="12" fill="#444">Full account — what, how, what it looks like</text>
  <text x="115" y="295" font-family="Arial, sans-serif" font-size="12" fill="#444">Full paragraphs — do NOT use bullet list</text>
  <text x="70" y="350" font-family="Arial, sans-serif" font-size="11" fill="#C9A84C" font-weight="bold">Example:</text>
  <text x="115" y="350" font-family="Arial, sans-serif" font-size="11" fill="#666">"Describe hierarchy of control" → all 5 levels</text>

  <rect x="410" y="235" width="370" height="140" fill="white" rx="10" stroke="#C9A84C" stroke-width="1.5" stroke-opacity="0.3"/>
  <circle cx="460" cy="283" r="25" fill="#1B3A6B" opacity="0.12"/>
  <text x="460" y="290" text-anchor="middle" font-size="22">💡</text>
  <text x="505" y="257" font-family="Georgia, serif" font-size="16" font-weight="bold" fill="#1B3A6B">Explain</text>
  <text x="505" y="277" font-family="Arial, sans-serif" font-size="12" fill="#444">The WHY answer — cause and effect</text>
  <text x="505" y="295" font-family="Arial, sans-serif" font-size="12" fill="#444">Reasons + rationale — connect to scenario</text>
  <text x="460" y="350" font-family="Arial, sans-serif" font-size="11" fill="#C9A84C" font-weight="bold">Example:</text>
  <text x="505" y="350" font-family="Arial, sans-serif" font-size="11" fill="#666">"Explain why workers fail to report" → causes</text>

  <!-- ROW 3 — Suggest and Justify -->
  <rect x="20" y="390" width="370" height="140" fill="white" rx="10" stroke="#C9A84C" stroke-width="1.5" stroke-opacity="0.3"/>
  <circle cx="70" cy="438" r="25" fill="#1B3A6B" opacity="0.12"/>
  <text x="70" y="445" text-anchor="middle" font-size="22">💬</text>
  <text x="115" y="412" font-family="Georgia, serif" font-size="16" font-weight="bold" fill="#1B3A6B">Suggest</text>
  <text x="115" y="432" font-family="Arial, sans-serif" font-size="12" fill="#444">Propose a course of action from scenario</text>
  <text x="115" y="450" font-family="Arial, sans-serif" font-size="12" fill="#444">No single correct answer — must be scenario-based</text>
  <text x="70" y="505" font-family="Arial, sans-serif" font-size="11" fill="#C9A84C" font-weight="bold">Example:</text>
  <text x="115" y="505" font-family="Arial, sans-serif" font-size="11" fill="#666">"Suggest improvements" → name specific scenario facts</text>

  <rect x="410" y="390" width="370" height="140" fill="white" rx="10" stroke="#C9A84C" stroke-width="1.5" stroke-opacity="0.3"/>
  <circle cx="460" cy="438" r="25" fill="#1B3A6B" opacity="0.12"/>
  <text x="460" y="445" text-anchor="middle" font-size="22">⚖️</text>
  <text x="505" y="412" font-family="Georgia, serif" font-size="16" font-weight="bold" fill="#1B3A6B">Justify</text>
  <text x="505" y="432" font-family="Arial, sans-serif" font-size="12" fill="#444">Give reasons supporting a recommendation</text>
  <text x="505" y="450" font-family="Arial, sans-serif" font-size="12" fill="#444">Argue with scenario evidence — 3–4 reasons</text>
  <text x="460" y="505" font-family="Arial, sans-serif" font-size="11" fill="#C9A84C" font-weight="bold">Example:</text>
  <text x="505" y="505" font-family="Arial, sans-serif" font-size="11" fill="#666">"Justify consultant appointment" → argue from scenario</text>

  <rect y="540" width="800" height="20" fill="#1B3A6B" opacity="0.08" rx="0"/>
  <text x="400" y="554" text-anchor="middle" font-family="Arial, sans-serif" font-size="10" fill="#888">nebosh-assignment-help.co.uk</text>
</svg>
<figcaption style="font-size:0.85rem; color:#666; margin-top:0.5rem;">NEBOSH OBE command words — all six definitions with example questions and the answer format each requires.</figcaption>
</figure>
...
Our [NEBOSH open book exam help](/nebosh-assignment-help-online/) service addresses each failure directly. Command word coaching develops the muscle memory of correctly calibrating response depth before beginning to write. Scenario analysis coaching develops the habit of extracting and annotating specific scenario evidence before each answer. Mock OBE answer feedback on practice questions — reviewed by NEBOSH-qualified consultants — identifies command word and scenario application weaknesses before the real exam window opens.
...
*Word count: ~2,800*
*Page type: Service Page — Core Section OBE Hub*
*Central Entity: NEBOSH Open Book Exam*
*Topical Map Section: Core Section — Tier 1*
