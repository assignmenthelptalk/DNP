# NEBOSH IGC Assignment Help: IG1 and IG2 Guidance From Certified Safety Professionals

The NEBOSH International General Certificate in Occupational Health and Safety is an Ofqual-regulated qualification awarded by NEBOSH (National Examination Board in Occupational Safety and Health), assessed across two distinct units: IG1, the Management of International Health and Safety, examined by a 48-hour Open Book Exam, and IG2, the International Workplace Risk Assessment, assessed by a practical workplace report. Both units carry separate grade outcomes — Distinction, Credit, Pass, or Fail — and together determine the candidate's overall IGC result. Our team of NEBOSH-qualified health and safety professionals provides structured guidance for both units, supporting candidates at every stage from OBE preparation through to pre-submission report review.
...
<svg viewBox="0 0 800 420" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:800px; display:block; margin:0 auto;" role="img" aria-labelledby="igc-overview-title">
  <title id="igc-overview-title">NEBOSH IGC — Unit Structure, Frameworks, and International Recognition</title>
  <desc>An icon grid showing the four key attributes of the NEBOSH International General Certificate: IG1 OBE unit, IG2 practical unit, international frameworks (ILO-OSH 2001 / ISO 45001:2018), and global employer recognition.</desc>
  ...
  <text x="400" y="40" text-anchor="middle" font-family="Georgia, serif" font-size="22" font-weight="bold" fill="white">NEBOSH IGC — Qualification At a Glance</text>
  ...
  <text x="115" y="108" font-family="Georgia, serif" font-size="15" font-weight="bold" fill="#1B3A6B">IG1 — Open Book Exam</text>
  <text x="115" y="128" font-family="Arial, sans-serif" font-size="12" fill="#444">Management of International H&amp;S</text>
  <text x="115" y="146" font-family="Arial, sans-serif" font-size="12" fill="#444">48-hour window · 15 tasks</text>
  <text x="115" y="164" font-family="Arial, sans-serif" font-size="12" fill="#444">Scenario-based · NEBOSH portal</text>
  ...
  <text x="505" y="108" font-family="Georgia, serif" font-size="15" font-weight="bold" fill="#1B3A6B">IG2 — Practical Report</text>
  <text x="505" y="128" font-family="Arial, sans-serif" font-size="12" fill="#444">International Workplace</text>
  <text x="505" y="146" font-family="Arial, sans-serif" font-size="12" fill="#444">Risk Assessment Report</text>
  <text x="505" y="164" font-family="Arial, sans-serif" font-size="12" fill="#444">5+ hazards · Risk matrix</text>
  ...
  <text x="115" y="280" font-family="Georgia, serif" font-size="15" font-weight="bold" fill="#1B3A6B">International Frameworks</text>
  <text x="115" y="300" font-family="Arial, sans-serif" font-size="12" fill="#444">ILO-OSH 2001 — ILO guidelines</text>
  <text x="115" y="318" font-family="Arial, sans-serif" font-size="12" fill="#444">ISO 45001:2018 — replaced OHSAS</text>
  <text x="115" y="336" font-family="Arial, sans-serif" font-size="12" fill="#444">Not UK Acts — HSWA/MHSWR</text>
  <text x="115" y="381" font-family="Georgia, serif" font-size="18" font-weight="bold" fill="#C9A84C">Not HSWA 1974</text>
  ...
  <text x="505" y="280" font-family="Georgia, serif" font-size="15" font-weight="bold" fill="#1B3A6B">Global Recognition</text>
  <text x="505" y="300" font-family="Arial, sans-serif" font-size="12" fill="#444">UAE · Saudi Arabia · Qatar</text>
  <text x="505" y="318" font-family="Arial, sans-serif" font-size="12" fill="#444">India · Nigeria · Malaysia · UK</text>
  <text x="505" y="336" font-family="Arial, sans-serif" font-size="12" fill="#444">Preferred by multinational employers</text>
...
<figcaption style="font-size:0.85rem; color:#666; margin-top:0.5rem;">NEBOSH IGC assignment help — unit structure, international frameworks, and global employer recognition at a glance.</figcaption>
</figure>
...
<figure class="infographic-figure" style="text-align:center; margin: 2rem auto;">
<svg viewBox="0 0 800 480" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:800px; display:block; margin:0 auto;" role="img" aria-labelledby="cmd-words-title">
  <title id="cmd-words-title">NEBOSH OBE Command Words — Six Definitions With Required Response Depth</title>
  <desc>Colour-coded comparison table of the six NEBOSH Open Book Exam command words: Identify, Outline, Describe, Explain, Suggest, and Justify — showing the required answer format for each.</desc>
  ...
  <text x="400" y="38" text-anchor="middle" font-family="Georgia, serif" font-size="20" font-weight="bold" fill="white">NEBOSH OBE Command Words — Response Depth Guide</text>
  <rect y="60" width="800" height="3" fill="#C9A84C"/>

  <!-- Column headers -->
  <rect x="0" y="63" width="800" height="44" fill="#1B3A6B" opacity="0.08"/>
  <text x="100" y="91" text-anchor="middle" font-family="Georgia, serif" font-size="13" font-weight="bold" fill="#1B3A6B">Command Word</text>
  <text x="340" y="91" text-anchor="middle" font-family="Georgia, serif" font-size="13" font-weight="bold" fill="#1B3A6B">Required Response</text>
  <text x="660" y="91" text-anchor="middle" font-family="Georgia, serif" font-size="13" font-weight="bold" fill="#1B3A6B">Format Guidance</text>
  <line x1="200" y1="63" x2="200" y2="480" stroke="#ddd" stroke-width="1"/>
  <line x1="490" y1="63" x2="490" y2="480" stroke="#ddd" stroke-width="1"/>

  <!-- ROW 1 — Identify -->
  <rect x="0" y="107" width="800" height="52" fill="white"/>
  <text x="100" y="138" text-anchor="middle" font-family="Georgia, serif" font-size="14" font-weight="bold" fill="#C9A84C">Identify</text>
  <text x="340" y="132" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Name or recognise — brief and specific</text>
  <text x="340" y="150" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">No explanation needed</text>
  <text x="660" y="138" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Bullet list · short phrases only</text>

  <!-- ROW 2 — Outline -->
  <rect x="0" y="159" width="800" height="52" fill="#1B3A6B" opacity="0.04"/>
  <text x="100" y="190" text-anchor="middle" font-family="Georgia, serif" font-size="14" font-weight="bold" fill="#C9A84C">Outline</text>
  <text x="340" y="184" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Most important points — less than Describe</text>
  <text x="340" y="202" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Key features, not full detail</text>
  <text x="660" y="190" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Bullets acceptable · 4–6 points</text>

  <!-- ROW 3 — Describe -->
  <rect x="0" y="211" width="800" height="52" fill="white"/>
  <text x="100" y="242" text-anchor="middle" font-family="Georgia, serif" font-size="14" font-weight="bold" fill="#C9A84C">Describe</text>
  <text x="340" y="236" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Give a detailed account — what, how, what it</text>
  <text x="340" y="254" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">looks like in practice — full detail expected</text>
  <text x="660" y="242" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Full paragraphs · no bullet reduction</text>

  <!-- ROW 4 — Explain -->
  <rect x="0" y="263" width="800" height="52" fill="#1B3A6B" opacity="0.04"/>
  <text x="100" y="294" text-anchor="middle" font-family="Georgia, serif" font-size="14" font-weight="bold" fill="#C9A84C">Explain</text>
  <text x="340" y="288" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Make clear — state WHY, not just WHAT</text>
  <text x="340" y="306" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Causation required — link to scenario</text>
  <text x="660" y="294" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Causal sentences · reason-outcome pairs</text>

  <!-- ROW 5 — Suggest -->
  <rect x="0" y="315" width="800" height="52" fill="white"/>
  <text x="100" y="346" text-anchor="middle" font-family="Georgia, serif" font-size="14" font-weight="bold" fill="#C9A84C">Suggest</text>
  <text x="340" y="340" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Propose a course of action — grounded in</text>
  <text x="340" y="358" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">scenario context — no single right answer</text>
  <text x="660" y="346" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Scenario-specific · reasoned proposals</text>

  <!-- ROW 6 — Justify -->
  <rect x="0" y="367" width="800" height="52" fill="#1B3A6B" opacity="0.04"/>
  <text x="100" y="398" text-anchor="middle" font-family="Georgia, serif" font-size="14" font-weight="bold" fill="#C9A84C">Justify</text>
  <text x="340" y="392" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Give reasons for a recommendation</text>
  <text x="340" y="410" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Evidence-linked — reference scenario facts</text>
  <text x="660" y="398" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Argument structure · scenario evidence</text>

  <rect x="0" y="428" width="800" height="40" fill="#1B3A6B" opacity="0.06" rx="0"/>
  <text x="400" y="453" text-anchor="middle" font-family="Arial, sans-serif" font-size="10" fill="#888">nebosh-assignment-help.co.uk</text>
</svg>
<figcaption style="font-size:0.85rem; color:#666; margin-top:0.5rem;">NEBOSH OBE command words — the six definitions that determine how every IG1 task answer must be structured.</figcaption>
</figure>
...
<figure class="infographic-figure" style="text-align:center; margin: 2rem auto;">
<svg viewBox="0 0 800 300" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:800px; display:block; margin:0 auto;" role="img" aria-labelledby="ig2-process-title">
  <title id="ig2-process-title">NEBOSH IG2 Risk Assessment Report — Five Required Steps Per Hazard</title>
  <desc>A process flow showing the five required elements for each hazard in the NEBOSH IG2 practical risk assessment: Identify Hazard, Identify Who Is at Risk, Apply Risk Matrix, Specify Controls, Assign Priority.</desc>
  ...
  <text x="400" y="34" text-anchor="middle" font-family="Georgia, serif" font-size="18" font-weight="bold" fill="white">NEBOSH IG2 — Five Required Elements Per Hazard</text>
  ...
  <text x="100" y="116" text-anchor="middle" font-size="22">⚠️</text>
  <text x="100" y="205" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#1B3A6B">Identify Hazard</text>
  <text x="100" y="222" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Source, nature</text>
  <text x="100" y="237" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">and location</text>
  ...
  <text x="300" y="205" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#1B3A6B">Who Is at Risk</text>
  <text x="300" y="222" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Persons affected</text>
  <text x="300" y="237" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">and how harmed</text>
  ...
  <text x="500" y="205" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#1B3A6B">Risk Matrix</text>
  <text x="500" y="222" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Likelihood (1–5)</text>
  <text x="500" y="237" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">× Consequence (1–5)</text>
  <polygon points="548,149 548,161 562,155" fill="#C9A84C" opacity="0.7"/>

  <!-- STEP 4 -->
  <circle cx="660" cy="155" r="36" fill="#C9A84C"/>
  <circle cx="660" cy="155" r="32" fill="#1B3A6B"/>
  <text x="660" y="147" text-anchor="middle" font-family="Georgia, serif" font-size="11" fill="white" opacity="0.7">STEP</text>
  <text x="660" y="165" text-anchor="middle" font-family="Georgia, serif" font-size="18" font-weight="bold" fill="white">4+5</text>
  <text x="660" y="116" text-anchor="middle" font-size="22">🛡️</text>
  <text x="660" y="205" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#1B3A6B">Controls + Priority</text>
  <text x="660" y="222" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Hierarchy: Eliminate</text>
  <text x="660" y="237" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">→ Sub → Eng → Admin → PPE</text>

  <text x="400" y="285" text-anchor="middle" font-family="Arial, sans-serif" font-size="10" fill="#aaa">nebosh-assignment-help.co.uk</text>
</svg>
<figcaption style="font-size:0.85rem; color:#666; margin-top:0.5rem;">NEBOSH IG2 practical assessment — the five required elements that must be documented for each of the minimum five identified hazards.</figcaption>
</figure>
...
Candidates who sit the [NEBOSH NGC assignment help](/nebosh-ngc-assignment-help/) route study UK domestic legislation — HSWA 1974, MHSWR 1999, RIDDOR 2013, and a set of specific Regulations — because the NGC is designed for the UK employer market. IGC candidates working outside the UK should not migrate UK statutory references into their IG1 answers: the marking criteria for IGC tasks does not give credit for HSWA citations where ILO-OSH or ISO 45001 references are appropriate.
...
**Internal links:**
- [NEBOSH NGC for UK legislation](/nebosh-ngc-assignment-help/)
- [NEBOSH open book exam strategy](/nebosh-open-book-exam-help/)
- [NEBOSH Assignment Help Online](/nebosh-assignment-help-online/)

---

### From NEBOSH IGC to NEBOSH Diploma: The Progression Route
...
*Word count: ~2,850*
*Page type: Service Page — Core Section Hub*
*Central Entity: NEBOSH IGC assignment*
*Topical Map Section: Core Section — Tier 1 Hub Page*
