"""
generate_header_btec.py — BTEC Assignment Help header images
Produces 1200×420 WebP headers for all BTEC pages.
Brand: deep navy #0D2B6B + orange #F97316

HOW TO USE
----------
1. Drop your grid image into: client_data/New-sites/btec-assignment-help/input images/
2. Set GRID_COLS and GRID_ROWS below to match the grid dimensions of your image.
3. Run:  python generate_header_btec.py
...
CLIENT = {
    "brand":       (13,  43,  107),   # Deep navy    #0D2B6B — border fill
    "accent":      (249, 115, 22),    # Orange       #F97316 — diamond tiles + accents
    "panel":       (8,   27,  68),    # Darker navy              — text panel fill
    "logo_line1":  "BTEC",
    "logo_line2":  "Assignment Help",
    "input_dir":   r"C:\Users\jobmu\agentic-workflow\semantic-seo-workflow\client_data\New-sites\btec-assignment-help\input images",
    "output_dir":  r"C:\Users\jobmu\my-second-projects\btec-assignment-help\public",
}
...
PAGES = [
    {"slug": "header_btec-assignment-help",                              "title": "BTEC\nASSIGNMENT\nHELP"},
    {"slug": "header_btec-national-assignment-help",                     "title": "BTEC NATIONAL\nASSIGNMENT\nHELP"},
    {"slug": "header_btec-hnc-assignment-help",                          "title": "BTEC HNC\nASSIGNMENT\nHELP"},
    {"slug": "header_btec-hnd-assignment-help",                          "title": "BTEC HND\nASSIGNMENT\nHELP"},
    {"slug": "header_btec-business-assignment-help",                     "title": "BTEC BUSINESS\nASSIGNMENT\nHELP"},
    {"slug": "header_btec-health-and-social-care-assignment-help",       "title": "BTEC HEALTH\n& SOCIAL CARE\nASSIGNMENT HELP"},
    {"slug": "header_btec-engineering-assignment-help",                  "title": "BTEC ENGINEERING\nASSIGNMENT\nHELP"},
    {"slug": "header_btec-it-assignment-help",                           "title": "BTEC IT\nASSIGNMENT\nHELP"},
    {"slug": "header_btec-sport-assignment-help",                        "title": "BTEC SPORT\nASSIGNMENT\nHELP"},
    {"slug": "header_btec-public-services-assignment-help",              "title": "BTEC PUBLIC\nSERVICES\nASSIGNMENT HELP"},
    {"slug": "header_btec-assignment-grading-criteria-explained",        "title": "BTEC GRADING\nCRITERIA\nEXPLAINED"},
    {"slug": "header_how-to-achieve-distinction-in-btec-assignments",    "title": "HOW TO ACHIEVE\nDISTINCTION\nIN BTEC"},
    {"slug": "header_btec-assignment-resubmission-guide",                "title": "BTEC REFERRAL\n& RESUBMISSION\nGUIDE"},
    {"slug": "header_btec-assignment-brief-how-to-read-and-interpret-it","title": "BTEC ASSIGNMENT\nBRIEF GUIDE\nINTERPRETATION"},
    {"slug": "header_btec-childcare-and-early-years-assignment-help",    "title": "BTEC CHILDCARE\n& EARLY YEARS\nASSIGNMENT HELP"},
]
