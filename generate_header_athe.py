"""
generate_header_athe.py — ATHE Assignment Help header images
Produces 1200×420 WebP headers for all ATHE pages.
Brand: dark navy #1B2B4B + emerald #2ECC71

HOW TO USE
----------
1. Drop your grid image into: client_data/New-sites/athe-assignment-help/input images/
2. Set GRID_COLS and GRID_ROWS below to match the grid dimensions of your image.
3. Run:  python generate_header_athe.py
...
CLIENT = {
    "brand":       (27,  43,  75),    # Dark navy    #1B2B4B — border fill
    "accent":      (46,  204, 113),   # Emerald      #2ECC71 — diamond tiles + accents
    "panel":       (17,  27,  48),    # Darker navy              — text panel fill
    "logo_line1":  "ATHE",
    "logo_line2":  "Assignment Help",
    "input_dir":   r"C:\Users\jobmu\agentic-workflow\semantic-seo-workflow\client_data\New-sites\athe-assignment-help\input images",
    "output_dir":  r"C:\Users\jobmu\my-second-projects\athe-assignment-help\public",
}

# ── Grid configuration ───────────────────────────────────────────────────────
# Set to match your grid image dimensions.
# 14 pages → 3 cols × 5 rows = 15 cells (last cell unused).
GRID_COLS = 3
GRID_ROWS = 5
# ─────────────────────────────────────────────────────────────────────────────

PAGES = [
    {"slug": "header_athe-assignment-help",                                        "title": "ATHE\nASSIGNMENT\nHELP"},
    {"slug": "header_athe-level-3-assignment-help",                                "title": "ATHE LEVEL 3\nASSIGNMENT\nHELP"},
    {"slug": "header_athe-level-4-assignment-help",                                "title": "ATHE LEVEL 4\nASSIGNMENT\nHELP"},
    {"slug": "header_athe-level-5-assignment-help",                                "title": "ATHE LEVEL 5\nASSIGNMENT\nHELP"},
    {"slug": "header_athe-level-6-assignment-help",                                "title": "ATHE LEVEL 6\nASSIGNMENT\nHELP"},
    {"slug": "header_athe-level-7-assignment-help",                                "title": "ATHE LEVEL 7\nASSIGNMENT\nHELP"},
    {"slug": "header_athe-business-management-assignment-help",                    "title": "ATHE BUSINESS\nMANAGEMENT\nASSIGNMENT HELP"},
    {"slug": "header_athe-healthcare-management-assignment-help",                  "title": "ATHE HEALTHCARE\nMANAGEMENT\nASSIGNMENT HELP"},
    {"slug": "header_athe-assignment-grading-criteria-pass-merit-and-distinction-explained", "title": "ATHE GRADING\nCRITERIA\nEXPLAINED"},
    {"slug": "header_how-to-achieve-merit-and-distinction-in-athe-assignments",    "title": "HOW TO ACHIEVE\nDISTINCTION\nIN ATHE"},
    {"slug": "header_athe-assignment-referral-and-resubmission-guide",             "title": "ATHE REFERRAL\n& RESUBMISSION\nGUIDE"},
    {"slug": "header_harvard-referencing-for-athe-assignments",                    "title": "HARVARD\nREFERENCING\nFOR ATHE"},
    {"slug": "header_athe-tourism-and-hospitality-management-assignment-help",     "title": "ATHE TOURISM\n& HOSPITALITY\nASSIGNMENT HELP"},
    {"slug": "header_athe-computing-assignment-help",                              "title": "ATHE COMPUTING\nASSIGNMENT\nHELP"},
]
...
def page_zone(idx):
    """Auto-compute zone fraction from grid position."""
    r = idx // GRID_COLS
    c = idx % GRID_COLS
...
def generate(page, client, source, zone):
    ...
    draw.text((tx, logo_y),      client["logo_line1"], fill=accent,          font=get_font(22, bold=True))
    ...
    out = os.path.join(client["output_dir"], page["slug"] + ".webp")
