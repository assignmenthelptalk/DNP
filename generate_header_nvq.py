"""
generate_header_nvq.py — NVQ Assignment Help header images
Produces 1200×420 WebP headers for all NVQ pages.
Brand: dark teal #134E4A + orange #EA580C

HOW TO USE
----------
1. Drop your grid image into: client_data/New-sites/nvq-assignment-help/input images/
2. Set GRID_COLS and GRID_ROWS below to match the grid dimensions of your image.
3. Run:  python generate_header_nvq.py
...
CLIENT = {
    "brand":       (19,  78,  74),    # Dark teal    #134E4A — border fill
    "accent":      (234, 88,  12),    # Orange       #EA580C — diamond tiles + accents
    "panel":       (12,  49,  47),    # Darker teal              — text panel fill
    "logo_line1":  "NVQ",
    "logo_line2":  "Assignment Help",
    "input_dir":   r"C:\Users\jobmu\agentic-workflow\semantic-seo-workflow\client_data\New-sites\nvq-assignment-help\input images",
    "output_dir":  r"C:\Users\jobmu\my-second-projects\nvq-assignment-help\public",
}

GRID_COLS = 3
GRID_ROWS = 4   # 12 cells for 12 pages

PAGES = [
    {"slug": "header_nvq-assignment-help",                                      "title": "NVQ\nASSIGNMENT\nHELP"},
    {"slug": "header_nvq-portfolio-evidence-help",                              "title": "NVQ PORTFOLIO\nEVIDENCE\nHELP"},
    {"slug": "header_nvq-reflective-account-writing-help",                      "title": "NVQ REFLECTIVE\nACCOUNT\nWRITING HELP"},
    {"slug": "header_nvq-health-and-social-care-assignment-help",               "title": "NVQ HEALTH\n& SOCIAL CARE\nASSIGNMENT HELP"},
    {"slug": "header_nvq-level-3-assignment-help",                              "title": "NVQ LEVEL 3\nASSIGNMENT\nHELP"},
    {"slug": "header_nvq-level-2-assignment-help",                              "title": "NVQ LEVEL 2\nASSIGNMENT\nHELP"},
    {"slug": "header_nvq-business-administration-assignment-help",              "title": "NVQ BUSINESS\nADMIN\nASSIGNMENT HELP"},
    {"slug": "header_nvq-personal-statement-writing-help",                      "title": "NVQ PERSONAL\nSTATEMENT\nWRITING HELP"},
    {"slug": "header_nvq-witness-testimony-guide",                              "title": "NVQ WITNESS\nTESTIMONY\nGUIDE"},
    {"slug": "header_nvq-management-and-leadership-assignment-help",            "title": "NVQ MANAGEMENT\n& LEADERSHIP\nASSIGNMENT HELP"},
    {"slug": "header_nvq-childcare-assignment-help",                            "title": "NVQ CHILDCARE\nASSIGNMENT\nHELP"},
    {"slug": "header_nvq-assignment-evidence-referral-and-resubmission-guide",  "title": "NVQ EVIDENCE\nREFERRAL &\nRESUBMISSION"},
]
