"""
generate_header_cache.py — CACHE Assignment Help header images
Produces 1200×420 WebP headers for all CACHE pages.
Brand: dark forest green #1B4332 + emerald #10B981

HOW TO USE
----------
1. Drop your grid image into: client_data/New-sites/cache-assignment-help/input images/
2. Set GRID_COLS and GRID_ROWS below to match the grid dimensions of your image.
3. Run:  python generate_header_cache.py
...
CLIENT = {
    "brand":       (27,  67,  50),    # Dark green   #1B4332 — border fill
    "accent":      (16,  185, 129),   # Emerald      #10B981 — diamond tiles + accents
    "panel":       (17,  42,  32),    # Darker green             — text panel fill
    "logo_line1":  "CACHE",
    "logo_line2":  "Assignment Help",
    "input_dir":   r"C:\Users\jobmu\agentic-workflow\semantic-seo-workflow\client_data\New-sites\cache-assignment-help\input images",
    "output_dir":  r"C:\Users\jobmu\my-second-projects\cache-assignment-help\public",
}

GRID_COLS = 3
GRID_ROWS = 5   # 15 cells for 14 pages (last cell unused)

PAGES = [
    {"slug": "header_cache-assignment-help",                                      "title": "CACHE\nASSIGNMENT\nHELP"},
    {"slug": "header_cache-level-3-early-years-assignment-help",                  "title": "CACHE LEVEL 3\nEARLY YEARS\nASSIGNMENT HELP"},
    {"slug": "header_cache-level-3-health-and-social-care-assignment-help",       "title": "CACHE LEVEL 3\nHEALTH & SOCIAL\nCARE HELP"},
    {"slug": "header_cache-level-2-assignment-help",                              "title": "CACHE LEVEL 2\nASSIGNMENT\nHELP"},
    {"slug": "header_cache-observation-record-writing-help",                      "title": "CACHE OBSERVATION\nRECORD\nWRITING HELP"},
    {"slug": "header_cache-reflective-account-writing-help",                      "title": "CACHE REFLECTIVE\nACCOUNT\nWRITING HELP"},
    {"slug": "header_cache-safeguarding-assignment-help",                         "title": "CACHE SAFEGUARDING\nASSIGNMENT\nHELP"},
    {"slug": "header_eyfs-framework-in-cache-assignments-explained",              "title": "EYFS FRAMEWORK\nIN CACHE\nEXPLAINED"},
    {"slug": "header_child-development-theory-for-cache-assignments",             "title": "CHILD DEVELOPMENT\nTHEORY\nFOR CACHE"},
    {"slug": "header_cache-level-4-and-level-5-assignment-help",                  "title": "CACHE LEVEL 4\n& LEVEL 5\nASSIGNMENT HELP"},
    {"slug": "header_cache-send-and-inclusion-assignment-help",                   "title": "CACHE SEND\n& INCLUSION\nASSIGNMENT HELP"},
    {"slug": "header_cache-assignment-referral-and-resubmission-guide",           "title": "CACHE REFERRAL\n& RESUBMISSION\nGUIDE"},
    {"slug": "header_cache-portfolio-evidence-guide",                             "title": "CACHE PORTFOLIO\nEVIDENCE\nGUIDE"},
    {"slug": "header_cache-health-and-safety-in-early-years-assignment-help",     "title": "CACHE HEALTH\n& SAFETY\nEARLY YEARS"},
]
