"""
generate_header_hnc.py — HNC Assignment Help header images
Produces 1200×420 WebP headers for all HNC pages.
Brand: navy #1E3A5F + amber #F59E0B

HOW TO USE
----------
1. Drop your grid image into: client_data/New-sites/hnc-assignment-help/input images/
2. Set GRID_COLS and GRID_ROWS below to match the grid dimensions of your image.
3. Run:  python generate_header_hnc.py
...
CLIENT = {
    "brand":       (30,  58,  95),    # Navy         #1E3A5F — border fill
    "accent":      (245, 158, 11),    # Amber        #F59E0B — diamond tiles + accents
    "panel":       (19,  36,  60),    # Darker navy              — text panel fill
    "logo_line1":  "HNC",
    "logo_line2":  "Assignment Help",
    "input_dir":   r"C:\Users\jobmu\agentic-workflow\semantic-seo-workflow\client_data\New-sites\hnc-assignment-help\input images",
    "output_dir":  r"C:\Users\jobmu\my-second-projects\hnc-assignment-help\public",
}

GRID_COLS = 3
GRID_ROWS = 5   # 15 cells for 15 pages

PAGES = [
    {"slug": "header_hnc-assignment-help",                                              "title": "HNC\nASSIGNMENT\nHELP"},
    {"slug": "header_hnc-business-assignment-help",                                     "title": "HNC BUSINESS\nASSIGNMENT\nHELP"},
    {"slug": "header_hnc-computing-assignment-help",                                    "title": "HNC COMPUTING\nASSIGNMENT\nHELP"},
    {"slug": "header_hnc-engineering-assignment-help",                                  "title": "HNC ENGINEERING\nASSIGNMENT\nHELP"},
    {"slug": "header_hnc-health-and-social-care-assignment-help",                       "title": "HNC HEALTH\n& SOCIAL CARE\nASSIGNMENT HELP"},
    {"slug": "header_hnc-assignment-grading-criteria-explained",                        "title": "HNC GRADING\nCRITERIA\nEXPLAINED"},
    {"slug": "header_how-to-achieve-merit-and-distinction-in-hnc-assignments",          "title": "HOW TO ACHIEVE\nDISTINCTION\nIN HNC"},
    {"slug": "header_transitioning-from-btec-level-3-to-hnc-what-changes-in-your-assignments", "title": "BTEC LEVEL 3\nTO HNC\nTRANSITION GUIDE"},
    {"slug": "header_hnc-assignment-resubmission-guide",                                "title": "HNC REFERRAL\n& RESUBMISSION\nGUIDE"},
    {"slug": "header_harvard-referencing-for-hnc-assignments",                          "title": "HARVARD\nREFERENCING\nFOR HNC"},
    {"slug": "header_hnc-construction-assignment-help",                                 "title": "HNC CONSTRUCTION\nASSIGNMENT\nHELP"},
    {"slug": "header_hnc-hospitality-management-assignment-help",                       "title": "HNC HOSPITALITY\nMANAGEMENT\nASSIGNMENT HELP"},
    {"slug": "header_hnc-sport-assignment-help",                                        "title": "HNC SPORT\nASSIGNMENT\nHELP"},
    {"slug": "header_hnc-business-research-project-assignment-help",                    "title": "HNC BUSINESS\nRESEARCH PROJECT\nASSIGNMENT HELP"},
    {"slug": "header_hnc-assignment-brief-how-to-read-and-interpret-it",                "title": "HNC ASSIGNMENT\nBRIEF\nINTERPRETATION"},
]
