"""
generate_header_ilm.py — ILM Assignment Help header images
Produces 1200×420 WebP headers for all ILM pages.
Brand: dark green #14532D + yellow/gold #EAB308

HOW TO USE
----------
1. Drop your grid image into: client_data/New-sites/ilm-assignment-help/input images/
2. Set GRID_COLS and GRID_ROWS below to match the grid dimensions of your image.
3. Run:  python generate_header_ilm.py
...
CLIENT = {
    "brand":       (20,  83,  45),    # Dark green   #14532D — border fill
    "accent":      (234, 179, 8),     # Gold         #EAB308 — diamond tiles + accents
    "panel":       (12,  52,  28),    # Darker green             — text panel fill
    "logo_line1":  "ILM",
    "logo_line2":  "Assignment Help",
    "input_dir":   r"C:\Users\jobmu\agentic-workflow\semantic-seo-workflow\client_data\New-sites\ilm-assignment-help\input images",
...
PAGES = [
    {"slug": "header_ilm-assignment-help",                            "title": "ILM\nASSIGNMENT\nHELP"},
    {"slug": "header_ilm-level-3-assignment-help",                    "title": "ILM LEVEL 3\nASSIGNMENT\nHELP"},
    {"slug": "header_ilm-level-5-assignment-help",                    "title": "ILM LEVEL 5\nASSIGNMENT\nHELP"},
    {"slug": "header_ilm-level-7-assignment-help",                    "title": "ILM LEVEL 7\nASSIGNMENT\nHELP"},
    {"slug": "header_ilm-coaching-and-mentoring-assignment-help",     "title": "ILM COACHING\n& MENTORING\nASSIGNMENT HELP"},
    {"slug": "header_ilm-reflective-account-writing-help",            "title": "ILM REFLECTIVE\nACCOUNT\nWRITING HELP"},
    {"slug": "header_ilm-work-based-evidence-guide",                  "title": "ILM WORK-BASED\nEVIDENCE\nGUIDE"},
    {"slug": "header_ilm-level-5-leadership-unit-assignment-help",    "title": "ILM LEVEL 5\nLEADERSHIP UNIT\nASSIGNMENT HELP"},
    {"slug": "header_ilm-level-5-management-unit-assignment-help",    "title": "ILM LEVEL 5\nMANAGEMENT UNIT\nASSIGNMENT HELP"},
    {"slug": "header_ilm-level-7-strategic-leadership-assignment-help","title": "ILM LEVEL 7\nSTRATEGIC\nLEADERSHIP HELP"},
    {"slug": "header_ilm-level-3-team-leader-assignment-help",        "title": "ILM LEVEL 3\nTEAM LEADER\nASSIGNMENT HELP"},
    {"slug": "header_ilm-assignment-referral-and-resubmission-guide", "title": "ILM REFERRAL\n& RESUBMISSION\nGUIDE"},
    {"slug": "header_leadership-styles-and-theories-for-ilm-assignments","title": "LEADERSHIP STYLES\n& THEORIES\nFOR ILM"},
    {"slug": "header_ilm-level-4-assignment-help",                    "title": "ILM LEVEL 4\nASSIGNMENT\nHELP"},
    {"slug": "header_ilm-assignment-harvard-referencing-guide",       "title": "ILM HARVARD\nREFERENCING\nGUIDE"},
]
