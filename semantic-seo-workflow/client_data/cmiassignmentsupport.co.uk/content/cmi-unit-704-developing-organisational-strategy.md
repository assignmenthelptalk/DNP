...
<!-- Components: "CMI Unit 704" badge | "Level 7 Diploma" badge | "Strategic Paper Format" badge | "5,000–6,500 Words" badge | "Critically Analyse" badge -->
<!-- Alt text: "CMI Unit 704 — Developing Organisational Strategy — Level 7 Diploma, strategic paper, Critically Analyse, 5,000 to 6,500 words" -->

**Get CMI 704 Assignment Help on WhatsApp — Senior Strategic Writers**
Send your unit brief, assignment question, and deadline for an immediate response.

---

## What Is CMI Unit 704 and What Does It Cover?
...
- **AC1** — Critically analyse the external environment to identify strategic opportunities and threats
- **AC2** — Critically analyse internal organisational capabilities to identify strategic strengths and limitations
- **AC3** — Develop and justify a strategic direction aligned to organisational capabilities and market context
...
| Section | Purpose | CMI 704 Notes |
|---|---|---|
| Title Page | Unit details, student information | Include "Unit 704 — Developing Organisational Strategy" |
| Executive Summary | Standalone strategic summary | 300–400 words. Summarises the external analysis findings, internal capability assessment, and recommended strategic direction — at board paper standard. |
| Contents Page | Section headings | — |
| Introduction | Organisational context, strategic scope | 300–400 words. Define the organisation — sector, size, current strategic position. Establish the strategic context and the analytical question the paper addresses. |
| AC1 Section | Critically analyse external environment | PESTLE (selected high-priority factors), Porter's Five Forces — both Critically Analysed |
| AC2 Section | Critically analyse internal capabilities | RBV, VRIO — applied to specific organisational resources and capabilities; dynamic capabilities framework |
| AC3 Section | Develop and justify strategic direction | Ansoff positioning, Generic Strategies — strategic direction justified against AC1/AC2 analysis with alternatives evaluated |
| Conclusion | Strategic synthesis | 250–350 words — the strategic argument summarised |
| Strategic Recommendations | 2–3 board-level recommendations | Strategic options with resource, governance, and implementation implications |
...
<!-- PORTER'S FIVE FORCES DIAGRAM — Place after Porter's Five Forces explanation, before RBV H3 -->
<!-- Components: Classic five-forces diagram — central box: "Competitive Rivalry" (with brief descriptor: intensity, number of competitors, switching costs). Four surrounding forces connected by arrows: top = "Threat of New Entrants" (barriers to entry, capital requirements, brand loyalty); bottom = "Threat of Substitutes" (switching costs, price-performance of substitutes); left = "Bargaining Power of Suppliers" (supplier concentration, switching costs, forward integration threat); right = "Bargaining Power of Buyers" (buyer concentration, price sensitivity, backward integration threat). Each force box includes a "High/Low pressure" indicator for the specific organisational context. Include note: "CMI 704 AC1 requires Critically Analyse — not a checklist. Assess which forces are most strategically significant and why." -->
<!-- Alt text: "Porter's Five Forces diagram for CMI Unit 704 — competitive rivalry at centre with threat of new entrants, bargaining power of suppliers and buyers, and threat of substitutes, for Developing Organisational Strategy" -->
...
- **Market penetration** (existing market, existing products): grow by taking share from competitors or increasing frequency of purchase. Lowest risk. Appropriate when the market is growing or when the organisation has under-exploited its current market position.
- **Market development** (new market, existing products): grow by entering new geographic or demographic markets with existing offerings. Moderate risk. Appropriate when the organisation's current offer has proved its value and the new market is accessible.
- **Product development** (existing market, new products): grow by developing new offerings for existing customers. Moderate risk. Requires strong customer knowledge and product development capability.
...
<!-- ANSOFF MATRIX — Place after Ansoff explanation, before Porter's Generic Strategies H3 -->
<!-- Components: 2×2 matrix — horizontal axis: "Markets" (Existing | New); vertical axis: "Products/Services" (Existing | New). Four quadrants: bottom-left = "Market Penetration" (lowest risk — "grow existing"); bottom-right = "Market Development" (moderate risk — "reach new markets"); top-left = "Product Development" (moderate risk — "create new offers"); top-right = "Diversification" (highest risk — "new territory"). Each quadrant includes: strategy name, risk level indicator, and one-line description. Colour gradient: green (low risk) → amber (moderate) → red (highest risk). -->
<!-- Alt text: "Ansoff Matrix for CMI Unit 704 — four strategic growth directions: Market Penetration, Market Development, Product Development, and Diversification, with risk levels indicated" -->
...
**For AC1 and AC2 — Critically Analyse:**
...
- Not listing PESTLE factors — selecting and analysing the two or three most strategically significant
- Not rating Porter's forces — examining which are most constraining and how they are changing
- Not describing VRIO — applying it to named organisational resources with specific evidence of value, rarity, and inimitability

**For AC3 — Develop:**
Develop requires producing an original strategic recommendation — not identifying a generic strategy from a textbook. The recommendation must:
...
- Be supported by evidence from strategy research or comparable organisational cases
- Address implementation implications at board scope — resources required, governance needed, risks to mitigate
...
**1. Frameworks applied mechanically, not Critically Analysed**
PESTLE and Porter's Five Forces used as templates to complete rather than as analytical frameworks to engage critically. No limitations examined, no prioritisation of significance, no competing perspectives engaged.

**2. RBV described without VRIO applied to specific resources**
The VRIO framework is introduced but applied generically — "the organisation has valuable human resources" — rather than specifically — examining a named capability against each VRIO criterion with evidence.

**3. AC3 strategy not grounded in AC1/AC2 analysis**
The strategic recommendation is made before or independent of the analysis. The strategy does not emerge from the environmental and capability findings — it is imposed on them. The assessor expects a logical thread from AC1 through AC2 to AC3.

**4. No dynamic capabilities engagement**
Static RBV analysis (what capabilities exist now) without dynamic capability analysis (can the organisation adapt those capabilities as the environment changes?) misses the most strategically important capability question for organisations in volatile environments.

**5. Operational scope**
Strategic analysis conducted at departmental or project level rather than at organisational or competitive level. The unit requires organisation-wide strategy development, not project planning.
...
- **Integrates AC1 and AC2 analytically before AC3** — the most strategically significant environmental factor (AC1) connects directly to the most relevant organisational capability or gap (AC2). The strategy in AC3 emerges from this intersection, not from the frameworks independently
- **Critiques frameworks at depth** — Porter's Five Forces limitations (complementors, collaborative relationships, industry disruption) engaged with specific evidence. RBV tautology critique addressed. Dynamic capabilities applied to evaluate whether the organisation's current capabilities will remain sources of advantage as the environment evolves
- **Evaluates strategic alternatives before recommending** — uses Ansoff to position the recommended direction against alternatives and provides evidence-based justification for why alternatives are less appropriate
- **Strategic recommendations address governance** — the Distinction-level AC3 recommendation identifies not just what strategy but who decides, who resources it, what governance structure oversees it, and what risk mitigants are required
...
**CMI 704 tutoring** — We plan your strategic analysis framework, guide your Critical Analysis approach for AC1 and AC2, and help you develop a justified strategic direction for AC3 that connects to your analysis. [View CMI assignment tutoring](/cmi-assignment-tutoring/)
...
**WhatsApp us with your CMI 704 brief for an immediate quote from a senior strategic writer.**
...
**[CMI 702 — Leading and Developing People](/cmi-level-7/unit-702-leading-developing-people/)** — organisational capability (702) is the internal resource base that the VRIO analysis in 704 AC2 examines. The capabilities built through talent and capability strategy in 702 become the sources of sustainable competitive advantage in 704.

**[CMI 705 — Leading Strategic Change](/cmi-level-7/unit-705-leading-strategic-change/)** — the strategic direction developed in 704 must be implemented through the strategic change process examined in 705. The two units are the strategy development and strategy execution pair of the Level 7 Diploma.

**[CMI 708 — Strategic Risk Management](/cmi-level-7/unit-708-strategic-risk-management/)** — the strategic risks inherent in the direction recommended in 704 are the subject of the risk governance analysis in 708.
