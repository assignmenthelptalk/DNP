# NEBOSH NGC Assignment Help: Expert Support for NG1 and NG2 Units

The NEBOSH National General Certificate in Occupational Health and Safety is an Ofqual-regulated qualification awarded by NEBOSH, assessed across two units: NG1, the Management of Health and Safety, examined by a 48-hour Open Book Exam, and NG2, the Workplace Risk Assessment, assessed by a practical report completed in the candidate's own workplace. The NGC carries a defining feature that distinguishes it structurally from the NEBOSH IGC: all NG1 OBE answers must apply named UK domestic legislation — Acts and Regulations with their year of enactment and the specific duties they impose — to the facts of the given scenario. Our NEBOSH-qualified health and safety professionals provide structured guidance for both NGC units, covering UK legislation application coaching, NG2 report writing, and pre-submission review.

---

## MAIN CONTENT

### What Is the NEBOSH NGC and Who Needs It
...
<svg viewBox="0 0 800 420" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:800px; display:block; margin:0 auto;" role="img" aria-labelledby="ngc-overview-title">
  <title id="ngc-overview-title">NEBOSH NGC — Unit Structure, UK Legislation, and Professional Pathway</title>
  <desc>Icon grid showing the four key attributes of the NEBOSH National General Certificate: NG1 OBE unit, NG2 practical unit, UK legislative framework, and GradIOSH professional pathway.</desc>
  ...
  <text x="400" y="40" text-anchor="middle" font-family="Georgia, serif" font-size="22" font-weight="bold" fill="white">NEBOSH NGC — Qualification At a Glance</text>
  ...
  <text x="115" y="108" font-family="Georgia, serif" font-size="15" font-weight="bold" fill="#1B3A6B">NG1 — Open Book Exam</text>
  <text x="115" y="128" font-family="Arial, sans-serif" font-size="12" fill="#444">Management of Health and Safety</text>
  <text x="115" y="146" font-family="Arial, sans-serif" font-size="12" fill="#444">48-hour window · 15 tasks</text>
  <text x="115" y="164" font-family="Arial, sans-serif" font-size="12" fill="#444">UK legislation applied to scenario</text>
  <text x="115" y="210" font-family="Georgia, serif" font-size="28" font-weight="bold" fill="#C9A84C">80%</text>
  <text x="175" y="210" font-family="Arial, sans-serif" font-size="12" fill="#666">= Distinction threshold</text>
  ...
  <text x="460" y="148" text-anchor="middle" font-size="26">🏗️</text>
  <text x="505" y="108" font-family="Georgia, serif" font-size="15" font-weight="bold" fill="#1B3A6B">NG2 — Practical Report</text>
  <text x="505" y="128" font-family="Arial, sans-serif" font-size="12" fill="#444">Workplace Risk Assessment</text>
  <text x="505" y="146" font-family="Arial, sans-serif" font-size="12" fill="#444">5+ hazards · Risk matrix</text>
  <text x="505" y="164" font-family="Arial, sans-serif" font-size="12" fill="#444">Likelihood (1–5) × Consequence (1–5)</text>
  <text x="505" y="210" font-family="Georgia, serif" font-size="28" font-weight="bold" fill="#C9A84C">5</text>
  <text x="535" y="210" font-family="Arial, sans-serif" font-size="12" fill="#666">minimum hazards required</text>

  <!-- CELL 3 — UK Legislation -->
  ...
  <text x="70" y="316" text-anchor="middle" font-size="26">⚖️</text>
  <text x="115" y="280" font-family="Georgia, serif" font-size="15" font-weight="bold" fill="#1B3A6B">UK Legislation Focus</text>
  <text x="115" y="300" font-family="Arial, sans-serif" font-size="12" fill="#444">HSWA 1974 · MHSWR 1999</text>
  <text x="115" y="318" font-family="Arial, sans-serif" font-size="12" fill="#444">RIDDOR 2013 · COSHH 2002</text>
  <text x="115" y="336" font-family="Arial, sans-serif" font-size="12" fill="#444">CDM 2015 · WAH 2005</text>
  <text x="115" y="381" font-family="Georgia, serif" font-size="16" font-weight="bold" fill="#C9A84C">Named Acts — Year — Duty</text>
  ...
  <text x="505" y="280" font-family="Georgia, serif" font-size="15" font-weight="bold" fill="#1B3A6B">GradIOSH Pathway</text>
  <text x="505" y="300" font-family="Arial, sans-serif" font-size="12" fill="#444">NGC → GradIOSH application</text>
  <text x="505" y="318" font-family="Arial, sans-serif" font-size="12" fill="#444">IOSH membership grade</text>
  <text x="505" y="336" font-family="Arial, sans-serif" font-size="12" fill="#444">Diploma → CMIOSH (Chartered)</text>
...
<figcaption style="font-size:0.85rem; color:#666; margin-top:0.5rem;">NEBOSH NGC assignment help — unit structure, UK legislative framework, and GradIOSH professional pathway at a glance.</figcaption>
</figure>
...
<figure class="infographic-figure" style="text-align:center; margin: 2rem auto;">
<svg viewBox="0 0 800 584" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:800px; display:block; margin:0 auto;" role="img" aria-labelledby="uk-leg-title">
  <title id="uk-leg-title">NEBOSH NGC — Key UK Health and Safety Legislation Reference Table</title>
  <desc>Colour-coded comparison table showing the primary UK H&amp;S legislation for the NEBOSH NGC: HSWA 1974, MHSWR 1999, RIDDOR 2013, COSHH 2002, Manual Handling 1992, CDM 2015, Working at Height 2005, and Noise at Work 2005.</desc>
  <rect width="800" height="584" fill="#F8F9FC" rx="12"/>
  <rect width="800" height="60" fill="#1B3A6B" rx="12"/>
  <rect y="48" width="800" height="12" fill="#1B3A6B"/>
  <text x="400" y="38" text-anchor="middle" font-family="Georgia, serif" font-size="18" font-weight="bold" fill="white">NEBOSH NGC — UK Legislation Reference</text>
  <rect y="60" width="800" height="3" fill="#C9A84C"/>

  <!-- Column headers -->
  <rect x="0" y="63" width="800" height="44" fill="#1B3A6B" opacity="0.08"/>
  <text x="130" y="91" text-anchor="middle" font-family="Georgia, serif" font-size="13" font-weight="bold" fill="#1B3A6B">Legislation</text>
  <text x="400" y="91" text-anchor="middle" font-family="Georgia, serif" font-size="13" font-weight="bold" fill="#1B3A6B">Core Duty</text>
  <text x="670" y="91" text-anchor="middle" font-family="Georgia, serif" font-size="13" font-weight="bold" fill="#1B3A6B">NGC Key Values</text>
  <line x1="250" y1="63" x2="250" y2="584" stroke="#ddd" stroke-width="1"/>
  <line x1="540" y1="63" x2="540" y2="584" stroke="#ddd" stroke-width="1"/>

  <!-- ROW 1 — HSWA 1974 -->
  <rect x="0" y="107" width="800" height="52" fill="white"/>
  <text x="130" y="132" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#C9A84C">HSWA 1974</text>
  <text x="130" y="150" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Health &amp; Safety at Work etc. Act</text>
  <text x="400" y="132" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">General duty — so far as reasonably practicable</text>
  <text x="400" y="150" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">S2 (employees), S3 (non-employees), S7 (workers)</text>
  <text x="670" y="141" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Primary legislation — overarching duty</text>

  <!-- ROW 2 -->
  <rect x="0" y="159" width="800" height="52" fill="#1B3A6B" opacity="0.04"/>
  <text x="130" y="184" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#C9A84C">MHSWR 1999</text>
  <text x="130" y="202" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Management of H&amp;S at Work Regs</text>
  <text x="400" y="184" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Reg 3: suitable &amp; sufficient risk assessment</text>
  <text x="400" y="202" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Reg 7: competent persons; Reg 5: arrangements</text>
  <text x="670" y="193" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Risk assessment duty — most cited Reg</text>

  <!-- ROW 3 -->
  <rect x="0" y="211" width="800" height="52" fill="white"/>
  <text x="130" y="236" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#C9A84C">RIDDOR 2013</text>
  <text x="130" y="254" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Reporting of Injuries, Diseases...</text>
  <text x="400" y="236" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Deaths/specified injuries: immediately</text>
  <text x="400" y="254" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Over-7-day incapacitation: within 15 days</text>
  <text x="670" y="245" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Exact thresholds required in answers</text>

  <!-- ROW 4 -->
  <rect x="0" y="263" width="800" height="52" fill="#1B3A6B" opacity="0.04"/>
  <text x="130" y="288" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#C9A84C">COSHH 2002</text>
  <text x="130" y="306" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Control of Substances Hazardous...</text>
  <text x="400" y="288" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">8-step assessment; hierarchy: eliminate →</text>
  <text x="400" y="306" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">substitute → enclose → ventilate → RPE</text>
  <text x="670" y="297" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Chemical/biological hazard scenarios</text>

  <!-- ROW 5 -->
  <rect x="0" y="315" width="800" height="52" fill="white"/>
  <text x="130" y="340" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#C9A84C">CDM 2015</text>
  <text x="130" y="358" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Construction Design &amp; Management</text>
  <text x="400" y="340" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Duty holders: Client, Principal Designer,</text>
  <text x="400" y="358" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Principal Contractor, Contractor, Worker</text>
  <text x="670" y="349" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Construction sector scenarios</text>

  <!-- ROW 6 -->
  <rect x="0" y="367" width="800" height="52" fill="#1B3A6B" opacity="0.04"/>
  <text x="130" y="392" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#C9A84C">WAH 2005</text>
  <text x="130" y="410" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Working at Height Regulations</text>
  <text x="400" y="392" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Hierarchy: avoid → prevent falls (collective)</text>
  <text x="400" y="410" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">→ mitigate consequences (personal protection)</text>
  <text x="670" y="401" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">WAH scenarios — hierarchy order critical</text>

  <!-- ROW 7 — Noise -->
  <rect x="0" y="419" width="800" height="52" fill="white"/>
  <text x="130" y="444" text-anchor="middle" font-family="Georgia, serif" font-size="12" font-weight="bold" fill="#C9A84C">Noise 2005</text>
  <text x="130" y="462" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Noise at Work Regulations</text>
  <text x="400" y="444" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Lower action: 80 dB(A) · Upper: 85 dB(A)</text>
  <text x="400" y="462" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#555">Exposure limit value: 87 dB(A)</text>
  <text x="670" y="453" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Exact dB(A) values needed in answers</text>

  <rect x="0" y="488" width="800" height="40" fill="#1B3A6B" opacity="0.06" rx="0"/>
  <text x="400" y="513" text-anchor="middle" font-family="Arial, sans-serif" font-size="10" fill="#888">nebosh-assignment-help.co.uk</text>
</svg>
<figcaption style="font-size:0.85rem; color:#666; margin-top:0.5rem;">NEBOSH NGC UK legislation reference — the primary Acts and Regulations candidates must apply by name, year, and specific duty in NG1 OBE answers.</figcaption>
</figure>
...
<figure class="infographic-figure" style="text-align:center; margin: 2rem auto;">
<svg viewBox="0 0 800 480" xmlns="http://www.w3.org/2000/svg" width="100%" style="max-width:800px; display:block; margin:0 auto;" role="img" aria-labelledby="ngc-igc-comp-title">
  <title id="ngc-igc-comp-title">NEBOSH NGC vs NEBOSH IGC — Structural Comparison</title>
  <desc>Side-by-side comparison of NEBOSH NGC and NEBOSH IGC showing identical assessment structure but different legislative frameworks: NGC uses UK domestic law, IGC uses ILO-OSH 2001 and ISO 45001:2018.</desc>
  <rect width="800" height="480" fill="#F8F9FC" rx="12"/>
  <rect width="800" height="64" fill="#1B3A6B" rx="12"/>
  <rect y="52" width="800" height="12" fill="#1B3A6B"/>
  <text x="400" y="40" text-anchor="middle" font-family="Georgia, serif" font-size="22" font-weight="bold" fill="white">NEBOSH NGC vs NEBOSH IGC</text>
  <rect y="64" width="800" height="3" fill="#C9A84C"/>
  <line x1="400" y1="80" x2="400" y2="460" stroke="#C9A84C" stroke-width="1.5" stroke-dasharray="6,4" stroke-opacity="0.4"/>

  <!-- NGC column -->
  <rect x="20" y="80" width="360" height="40" fill="#1B3A6B" opacity="0.08" rx="8"/>
  <text x="200" y="106" text-anchor="middle" font-family="Georgia, serif" font-size="17" font-weight="bold" fill="#1B3A6B">NEBOSH NGC</text>
  <text x="200" y="170" text-anchor="middle" font-size="60">🇬🇧</text>
  <text x="200" y="230" text-anchor="middle" font-family="Georgia, serif" font-size="14" font-weight="bold" fill="#C9A84C">UK Domestic Legislation</text>
  <text x="200" y="252" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">HSWA 1974 · MHSWR 1999</text>
  <text x="200" y="270" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">RIDDOR 2013 · COSHH 2002</text>
  <text x="200" y="288" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">CDM 2015 · WAH 2005</text>
  <rect x="40" y="305" width="320" height="34" fill="#1B3A6B" opacity="0.06" rx="6"/>
  <text x="200" y="327" text-anchor="middle" font-family="Arial, sans-serif" font-size="13" fill="#333">OBE: <tspan font-weight="bold">48 hours · 15 tasks</tspan></text>
  <rect x="40" y="344" width="320" height="34" fill="#1B3A6B" opacity="0.03" rx="6"/>
  <text x="200" y="366" text-anchor="middle" font-family="Arial, sans-serif" font-size="13" fill="#333">Audience: <tspan font-weight="bold">UK-based candidates</tspan></text>
  <rect x="40" y="383" width="320" height="34" fill="#1B3A6B" opacity="0.06" rx="6"/>
  <text x="200" y="405" text-anchor="middle" font-family="Arial, sans-serif" font-size="13" fill="#333">Pathway: <tspan font-weight="bold">GradIOSH → CMIOSH</tspan></text>

  <!-- IGC column -->
  <rect x="420" y="80" width="360" height="40" fill="#C9A84C" opacity="0.15" rx="8"/>
  <text x="600" y="106" text-anchor="middle" font-family="Georgia, serif" font-size="17" font-weight="bold" fill="#1B3A6B">NEBOSH IGC</text>
  <text x="600" y="170" text-anchor="middle" font-size="60">🌍</text>
  <text x="600" y="230" text-anchor="middle" font-family="Georgia, serif" font-size="14" font-weight="bold" fill="#C9A84C">International Frameworks</text>
  <text x="600" y="252" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">ILO-OSH 2001 Guidelines</text>
  <text x="600" y="270" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">ISO 45001:2018 Standard</text>
  <text x="600" y="288" text-anchor="middle" font-family="Arial, sans-serif" font-size="12" fill="#333">Not UK Acts or Regulations</text>
  <rect x="440" y="305" width="320" height="34" fill="#C9A84C" opacity="0.08" rx="6"/>
  <text x="600" y="327" text-anchor="middle" font-family="Arial, sans-serif" font-size="13" fill="#333">OBE: <tspan font-weight="bold">48 hours · 15 tasks</tspan></text>
  <rect x="440" y="344" width="320" height="34" fill="#C9A84C" opacity="0.04" rx="6"/>
  <text x="600" y="366" text-anchor="middle" font-family="Arial, sans-serif" font-size="13" fill="#333">Audience: <tspan font-weight="bold">International candidates</tspan></text>
  <rect x="440" y="383" width="320" height="34" fill="#C9A84C" opacity="0.08" rx="6"/>
  <text x="600" y="405" text-anchor="middle" font-family="Arial, sans-serif" font-size="13" fill="#333">Pathway: <tspan font-weight="bold">GradIOSH → CMIOSH</tspan></text>

  <text x="400" y="455" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" fill="#888">One key difference: legislative framework. Everything else is identical.</text>
  <text x="400" y="470" text-anchor="middle" font-family="Arial, sans-serif" font-size="10" fill="#aaa">nebosh-assignment-help.co.uk</text>
</svg>
<figcaption style="font-size:0.85rem; color:#666; margin-top:0.5rem;">NEBOSH NGC vs NEBOSH IGC — the legislative framework is the sole structural difference between two otherwise identical qualification formats.</figcaption>
</figure>
...
Our [NEBOSH NGC assignment help](/nebosh-assignment-help-online/) service provides structured guidance from NEBOSH-qualified practitioners with NGC and Diploma credentials, experienced in UK H&S legislative context across construction, manufacturing, healthcare, and facilities management.
...
Chartered Member status — CMIOSH — requires the NEBOSH Diploma (Level 6) alongside five or more years of H&S management experience and an approved CPD record. Candidates who complete the NGC with a Distinction grade and go on to enrol in [NEBOSH Diploma assignment support](/nebosh-diploma-assignment-help/) are progressing along the most direct route to Chartered status within the UK framework.
...
CMIOSH (Chartered Member of IOSH) is the higher grade, accessed through the NEBOSH Diploma route with five or more years' H&S management experience. The NGC alone does not lead to Chartered status. For candidates whose career target is CMIOSH, completing the [NEBOSH Diploma assignment help](/nebosh-diploma-assignment-help/) journey after the NGC is the standard pathway. Those still developing their OBE strategy across either qualification will find the [NEBOSH open book exam strategy](/nebosh-open-book-exam-help/) resource reinforces the command word methodology that applies equally to NG1 and IG1.
...
*Word count: ~2,950*
*Page type: Service Page — Core Section*
*Central Entity: NEBOSH NGC assignment*
*Topical Map Section: Core Section — Tier 2 Qualification-Specific Service Page*
